...
All notable changes to Clearer HN are documented here.
...
- The comment toolbar stays pinned to the top while scrolling a thread.
- Read / new-comment tracking: visited stories dim, and stories with new comments since your last visit show a "+N" badge.
- A "Replies to me" filter on the `threads` page.
- Submit-page hints: live title length, Show/Ask/Tell/Launch prefix detection, and a duplicate-URL check via HN's official search API.
- Light / dark / auto theme switcher in the header.
- A settings popup to toggle features on or off.

[1.0.0]: https://github.com/USERNAME/clearer-hn/releases/tag/v1.0.0
